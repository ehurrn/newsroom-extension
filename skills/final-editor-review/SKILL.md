...
- **Kill the draft** if claims are not legally defensible (even if "probably true")
- **Verify every financial assertion** against primary source documents
- **Convert editorializing verbs** (intended, deliberately, designed) into observable facts
- **Map each major claim** to its source (and ensure source is really what we think it says)
- **Flag "motive attribution"** (attributing intent without explicit evidence)
- **Enforce syntax standards** (definitive statements require bulletproof evidence)
- **Greenlight only articles** that survive aggressive fact-checking

---

## The Maximum Liability Posture
...
1. **It makes a factual claim** (not opinion; not hyperbole)
2. **About an identifiable person or entity**
3. **The claim is false** (or materially misleading)
4. **It was published** (yes, your article is published)
...
- Explicit evidence of agreement (email, recording, witness)
- Proof of intent (not just coincidence)
- Direct causation (payment caused decision)
...
### Trigger 2: Motive Attribution (Assuming Intent)
...
### Trigger 3: Editorializing Verbs (Judgment, Not Fact)
...
- Action: "The city did not conduct competitive bidding."
- Judgment: "The city negligently failed to conduct bidding."

### Trigger 4: Unsecured Financial Claims (No Paper Trail)
...
### Trigger 5: "Secret" or "Hidden" Claims (Without Evidence of Concealment)
...
## The Syntax Conversion Standard

### Rule 1: Definitive Intent Requires Explicit Evidence

**Risky:** "The mayor deliberately awarded the contract to her donor."

**Required evidence:**
- Email where mayor says she wants to give contract to donor, OR
- Meeting minutes showing mayor advocated specifically for this vendor, OR
- Memo from procurement officer saying mayor instructed them to award to vendor

**If evidence is not explicit:** Convert to observable facts.

### Rule 2: Absence of Evidence ≠ Evidence of Bad Intent
...
### Rule 3: Timing Proximity ≠ Causation
...
## Banned Words/Phrases & Alternatives
...
## The Final Editor's Checklist

Before marking article "approved for publication":

### Fact Verification (40% of review time)

- [ ] **All financial claims verified against primary documents** (never: "reportedly," "allegedly" for amounts)
- [ ] **All quotes checked against source recordings/transcripts** (no paraphrasing as direct quotes)
- [ ] **All date/time claims verified** (FOIA documents, meeting minutes, court filings)
- [ ] **All named individuals verified** (correct spelling, title, affiliation as of publication date)
- [ ] **All technical claims verified** (if article says "law requires X," check statute text)

### Libel Risk Assessment (40% of review time)

- [ ] **No quid pro quo claims without explicit evidence** (payment + decision + proof of causation)
- [ ] **No motive attribution without quotes or documented intent** (if saying "deliberately," have proof)
- [ ] **No editorializing verbs** (use "did not" instead of "failed to")
- [ ] **No unsecured financial claims** (all amounts backed by documents)
- [ ] **No "hidden" claims without evidence of concealment** (observable facts only)

### Source Verification (20% of review time)

- [ ] **All primary sources confirmed** (links work; quotes accurate; documents read in full)
- [ ] **All secondary sources checked** (did the news outlet quote the source correctly? can we verify?)
- [ ] **No sources cited without reader access** (if we cite a document, readers should be able to find it; link to FOIA repository)
- [ ] **Provenance documented** (where did we get this? FOIA? Public record? Interview?)

### Red Flags (Final Check)

- [ ] **No kill-the-draft triggers remain** (motive, quid pro quo, unproven intent)
- [ ] **Headline and lede match article** (no sensationalism in headline that article doesn't support)
- [ ] **Article doesn't imply illegal activity unless we prove elements of the crime** (theft, bribery, fraud all have legal definitions)
- [ ] **No single source for critical claim** (if major allegation rests on one person's word, mark as "according to [source]"; readers know to be skeptical)

---

## Interview Sourcing Standards
...
## The Publisher Greenlight Criteria

The final editor decides: **Can we defend this article if sued?**

### Greenlight Criteria (ALL must be true)

- [ ] **Every financial claim is documented** (primary source exists; no "reportedly")
- [ ] **Every quote is from a recording, transcript, or written document** (not reconstructed from memory)
...
**Approve:** "This article is legally defensible. All major claims are documented. We can win a defamation suit."
...
## Rewrite Requests (Not Rejection)
...
**Original sentence:**
"The mayor deliberately awarded the contract to her campaign donor to enrich herself."

**Issue:** Motive attribution ("deliberately," "to enrich herself"); quid pro quo claim ("awarded...to her donor")

**Rewrite request:**
"Change to: 'The mayor awarded the contract to a major campaign donor. The vendor had contributed $10,000 to her campaign in the preceding year. No competitive bidding was conducted. The mayor did not disclose the donor relationship to the city council.'"

**Why this works:** Facts + timing + omission. Readers infer quid pro quo without you asserting it. Legally defensible.

---

## Common Mistakes in Final Review
...
## Kill-the-Draft Examples

### Example 1: Unproven Quid Pro Quo
...
**Options:**
1. Kill the claim entirely (safer)
2. Rewrite as facts without the "exchange" implication: "The vendor paid the mayor $50,000. Two months later, the mayor awarded a contract to the vendor. No other vendors were solicited. The payment was not disclosed."

### Example 2: Unsecured Motive
...
**Options:**
1. Kill "deliberately" and "to benefit her friend"; rewrite as: "The mayor did not follow procurement rules. The selected vendor employs the mayor's college roommate. The relationship was not disclosed to the council."
2. Or kill the entire article if we can't prove anything but the selection.

### Example 3: Unverifiable Anonymous Source
...
**Options:**
1. Kill the claim (too risky)
2. Report it as "allegations" with official response: "An official, speaking anonymously, says the mayor pressured staff. The mayor denies this, saying all decisions are merit-based."

---

## Red Flags Requiring Editor Conversation

Before killing a draft, discuss with reporter:

1. **"We have a source who says..."** but no document backing it up → Get the document or kill the claim
2. **"It's widely known that..."** → Prove it with evidence, not generalities
3. **"The official refused to comment"** → Why? Did we ask? How? Document the attempt.
4. **"Multiple sources confirm..."** → How many? Are they credible? Can they be identified?
5. **"The absence of records suggests..."** → Careful; absence ≠ proof of wrongdoing. Report absence as fact.
...
- Defamation risk is significant but ambiguous
- Article touches on possible criminal activity (bribery, fraud, etc.)
- Single source is the only evidence for major claim
- Public figures vs. private citizens (different legal standards)

---

## Final Checklist Before Greenlight

- [ ] Every financial claim ≥$1,000 has primary source documentation
- [ ] Every quote is from recording, transcript, or written document
- [ ] No quid pro quo claims without explicit evidence
- [ ] No motive attribution without quotes/documents
- [ ] No "failed," "violated," "negligent" without specific factual foundation
- [ ] Named individuals given chance to respond (or article explains why not)
- [ ] Headline is accurate and not sensationalized
- [ ] Article is legally defensible if sued
- [ ] Sources are identified (or anonymity is justified)
- [ ] All kill-the-draft triggers have been removed or converted to safe language
